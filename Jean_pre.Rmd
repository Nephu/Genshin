...
Artefakty: +20, 5*, początkowe staty w ATK, ATK%, Crit rate, Crit Damage z wyjątkiem przypadków gdyby miały pokrywać się z główną statystyką. Zostają zastąpione wtedy dowolną inną statystyką. Uśredniona wartość tierów.
...
ggplot( ) +
  ...
  geom_point( data = filter(staty_pod_C, ASet == 1 & Rodzaj_ataku == c("Healing","Regen") ),
...
ggplot( ) +
  ...
  geom_point( data = filter(staty_pod_N, ASet == 2 & Rodzaj_ataku == c("Healing","Regen") ),
              aes( Art_type, DMG, color = Rodzaj_ataku) ) +
  ylab("Przeciętne obrażenia i leczenie") + xlab("Kombinacje artefaktów: Sands, Goblet, Circlet") +
  scale_fill_brewer( palette = "Set1") +
  scale_color_brewer() +
...
ggplot( ) +
  ...
  geom_point( data = filter(staty_pod_C, ASet == 3 & Rodzaj_ataku == c("Healing","Regen") ),
              aes( Art_type, DMG, color = Rodzaj_ataku) ) +
  ylab("Przeciętne obrażenia i leczenie") + xlab("Kombinacje artefaktów: Sands, Goblet, Circlet") +
  scale_fill_brewer( palette = "Set1") +
  scale_color_brewer() +
...
ggplot( ) +
  ...
  geom_point( data = filter(staty_pod_E, ASet == 4 & Rodzaj_ataku == c("Healing","Regen") ),
              aes( Art_type, DMG, color = Rodzaj_ataku) ) +
  ylab("Przeciętne obrażenia i leczenie") + xlab("Kombinacje artefaktów: Sands, Goblet, Circlet") +
  scale_fill_brewer( palette = "Set1") +
  scale_color_brewer() +
...
ggplot( ) +
  ...
  geom_point( data = filter(staty_pod_H, ASet == 5 & Rodzaj_ataku == c("Healing","Regen") ),
              aes( Art_type, DMG, color = Rodzaj_ataku) ) +
  ylab("Przeciętne obrażenia i leczenie") + xlab("Kombinacje artefaktów: Sands, Goblet, Circlet") +
  scale_fill_brewer( palette = "Set1") +
  scale_color_brewer() +
